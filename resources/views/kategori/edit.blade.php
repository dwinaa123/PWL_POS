    ...
    <div class="card-body">
        ...
        <form method="POST" action="{{ url('/kategori/'.$kategori->kategori_id) }}" class="form-horizontal">
            ...
            <div class="form-group row">
                ...
                <div class="col-10">
                    <input type="text" class="form-control" name="kodeKategori" value="{{ old('kodeKategori', $kategori->kategori_kode) }}" required>
                    @error('kodeKategori')
            ...
            <div class="form-group row">
                ...
                <div class="col-10">
                    <input type="text" class="form-control" name="namaKategori" value="{{ old('namaKategori', $kategori->nama) }}" required>
                    @error('namaKategori')
                    <small class="form-text text-danger">{{ $message }}</small>
                    @enderror
                </div>
